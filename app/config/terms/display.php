...
'GRID_SELECT_HINT' => [
    ...
    'publish_summary_worksite_notification' => [
        'fi' => 'Ilmoitus työmaille',
        'sv' => 'Avisering till arbetsplatser',
        'en' => 'Worksite notification',
        'it' => 'Notifica al cantiere',
        'el' => 'Ειδοποίηση εργοταξίου',
    ],
    'publish_worksite_recipients_count' => [
        'fi' => 'Ilmoitus lähetetään %d henkilölle',
        'sv' => 'Avisering skickas till %d person(er)',
        'en' => 'Notification will be sent to %d recipient(s)',
        'it' => 'La notifica verrà inviata a %d destinatario/i',
        'el' => 'Η ειδοποίηση θα σταλεί σε %d παραλήπτη/ες',
    ],
    'publish_worksite_recipients_none' => [
        'fi' => 'Ei vastaanottajia (kaikki valitut näytöt ovat SafetyFlashin omalla työmaalla)',
        'sv' => 'Inga mottagare (alla valda skärmar tillhör SafetyFlashens ursprungsarbetsplats)',
        'en' => 'No recipients (all selected displays belong to the SafetyFlash\'s own worksite)',
        'it' => 'Nessun destinatario (tutti i display selezionati appartengono al cantiere di origine)',
        'el' => 'Κανένας παραλήπτης (όλες οι επιλεγμένες οθόνες ανήκουν στο αρχικό εργοτάξιο)',
    ],
    'publish_worksite_recipients_loading' => [
        'fi' => 'Lasketaan vastaanottajia...',
        'sv' => 'Räknar mottagare...',
        'en' => 'Counting recipients...',
        'it' => 'Conteggio destinatari...',
        'el' => 'Υπολογισμός παραληπτών...',
    ],
...
'display_ttl_not_on_displays' => [
    ...
    'en' => 'Not on displays',
    'it' => 'Non sui display',
    'el' => 'Δεν εμφανίζεται στις οθόνες',
],
