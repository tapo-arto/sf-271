...
function sf_audit_action_label(string $action, string $lang = 'fi'): string
{
    $labels = [
        ...
        'flash_bulk_delete' => [
            ...
            'en' => 'Bulk delete',
            'it' => 'Eliminazione multipla Safetyflash',
            'el' => 'Μαζική διαγραφή Safetyflash',
        ],
        'flash_comment' => [
