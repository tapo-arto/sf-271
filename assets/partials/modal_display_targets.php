            ...
            <div class="sf-dt-tab-panel sf-dt-tab-panel-active" id="dtPanelTiming" data-tab-panel="timing" role="tabpanel" aria-labelledby="dtTabTiming">
                ...
                <div class="sf-dt-section">
                    ...
                    <div class="sf-ttl-preview sf-ttl-preview-hidden" id="dtTtlPreview">
                        ...
                        <span id="dtTtlPreviewLabel"><?= htmlspecialchars(sf_term('display_ttl_preview_label', $currentUiLang) ?? 'Poistuu näkyvistä', ENT_QUOTES, 'UTF-8') ?>:</span>
                        <span id="dtTtlPreviewDate"
                              data-no-limit-text="<?= htmlspecialchars(sf_term('display_ttl_preview_no_limit', $currentUiLang) ?? 'Näkyy toistaiseksi', ENT_QUOTES, 'UTF-8') ?>"></span>
                    </div>
                </div>
